          ...
          <div className=" pb-0 md:pb-[204px] ">
            ...
            <div className="   md:flex gap-[96px] items-end">
                <div className=" flex flex-col items-center  text-center  ">
                  ...
                  <p className='w-[214px] md:w-[220px] font-secondary text-details font-reguler  text-[17px] md:text-lg  leading-[29px] md:leading-[32px]'>From lists to boards, organize work your way. </p>
                </div>
                <div className=" mt-[20px] md:mt-[20px] text-center"><a className=' inline-block font-secondary font-medium cursor-pointer text-lg py-[20px] px-[48px] h-[60px] bg-secondary  leading-[20px] rounded-[6px] text-white :'>Get Started</a>
                </div>
              </div>
