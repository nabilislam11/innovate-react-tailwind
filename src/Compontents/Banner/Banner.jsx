      ...
      <div className="relative">
       ...
       <div className=" relative mt-8 text-center">
        <input className=' w-[480px] py-5  border pl-6 bg-white outline-0 placeholder:text-gray-400; text-gray-400 rounded-[6px]' type="text" placeholder='Your business email' />
           <a className=' flex items-center justify-center absolute top-[4px] left-[785px] my-[4px] mx-[4px] font-secondary font-medium text-lg h-[50px] w-[150px] bg-paimary rounded-[6px]   text-secondary'>Try for free</a>
       </div>
       <div className="">
