...
function Factssection() {
    return (
        <div>
            <Container>
                <div className=" flex  bg-[url('/src/assets/texter.png')] bg-no-repeat bg-secondary rounded-[40px] h-[468px] ">
                    <div className="mt-[44px] ml-[41px] content-end"><img className='  ' src={illustration} alt="#illustration" />
                    </div>


                    <div className="py-[85px] ml-[45px] items-center ">
                        <h1 className=' font-paimary  text-[44px] font-bold w-[554px]   text-white pb-[64px]'>Trusted by 35,000+ happy customers.</h1>
