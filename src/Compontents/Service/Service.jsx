...
function Service() {
  return (
    <div className=" pt-[40px] md:pt-[125px]  pb-[73px] md:pb-[158px]
    ">
          <Container>
      <div className='text-center  pb-[45px] md:pb-[80px] '>
      ...
      <div className="   md:flex justify-between items-center ">
        ...
        <div className="py-[36px] px-[36px] bg-white  mb-[20px] gap-[30px] boder-[10px] shadow-md group hover:bg-secondary  rounded-[20px] transition-all duration-500 ">
        ...
        <div className="py-[36px] px-[36px] bg-white  mb-[20px]  gap-[30px] shadow-md group hover:bg-secondary  rounded-[20px] transition-all duration-500">
